...
useHead({
  title: 'أقوال '+author_name,
  meta: [
    { name: 'title', content: 'أقوال '+author_name },
    { name: 'description', content: 'مجموعة منتقاة بعناية من الاقتباسات الملهمة من '+author_name  },
...
const allQuotes = ref<IQuote[]>((route.meta.author_quotes as IQuote[]))
